...
import java.net.URL;
public class ChangeAvailabilityGUITestTest {
  ...
  @Test
  public void changeAvailabilityGUITest() {
    ...
    {
      WebElement element = driver.findElement(By.linkText("My accommodations"));
    ...
    driver.findElement(By.cssSelector(".text-sm")).click();
    driver.findElement(By.cssSelector("input:nth-child(31)")).click();
    driver.findElement(By.cssSelector(".my-4")).click();
